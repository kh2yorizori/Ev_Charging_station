        ...
        <div class="board-form">
            ...
            <form action="${pageContext.request.contextPath}/board/modify" method="post">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="content" id="content" class="form-control" rows="10" required>${board.content}</textarea>
                </div>
                
                <div class="d-flex justify-content-end">
                    <a href="${pageContext.request.contextPath}/board/detail?boardId=${board.boardId}" class="btn btn-secondary me-2">취소</a>
