...
public class FavoriteServiceImpl implements FavoriteService {
    ...
    @Override
    public int addFavorite(String memberId, int stationId) {
    ...
    @Override
    public int deleteFavorite(String memberId, int stationId) {
    ...
    @Override
    public int checkFavorite(String memberId, int stationId) {
        HashMap<String, Object> param = new HashMap<>();
        param.put("memberId", memberId);
        param.put("stationId", stationId);
